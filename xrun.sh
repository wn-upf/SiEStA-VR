...
rates_bps_BGtraffic=(10E6 40E6 80E6 100E6)

N_XR=( 0 ) 
MLO_CONFIGS=("MLO0" "MLO1" "MLO2" "MLO3") ## MLO0: SLO -> 80 Mhz, MLO1 -> MLO 80_80 MHz , MLO2 -> MLO 80_160 MH< , MLO3 -> MLO 80_320 MHz channels 
