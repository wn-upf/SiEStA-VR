...
Simulator for setting up a number of N_XR VR sessions, with configurable distance to an AP. The VR streaming simulated sessions have the following structure: ![Alt text](assets/VR_emu_pipeline.png)
