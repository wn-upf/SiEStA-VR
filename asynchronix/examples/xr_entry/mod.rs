...
pub fn run_sim(params: SimParams) -> Result<()> {
    ...
    let name_folder = format!(
        "sim_T{:.0}_D{:.0}_Br{:.1}Mbps_PL{:.1}_NXR{:.0}_NBG{:.0}_BGLambda{:.2}pps_UL{:.0}_{suffix}_{video_filename}_FPS{:.0}_Nclose{:.0}_dclose{:.1}_S{:.0}_GoP{:.0}_IR{:.0}_ABR{:.0}_nest{:.0}_obs{:.0}_reward{:.0}_eval_{eval_string}_{mlo_channel_config}_EDCAbe{:.0}_{}_SocketRx{}",
