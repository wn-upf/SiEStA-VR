...
use crate::lib::alvr_stream_socket::{StreamSender, StreamSocketBuilder, VideoPacket, Haptics, VideoPacketHeader,
                                     ConResult ,ReceiverData, AnyhowToCon, Tracking, SocketProtocol, SocketBufferSize, DscpTos};
use crate::lib::alvr_packets::{ClientControlPacket, ClientStatistics, NetworkStatisticsPacket}; 


use crate::lib::alvr_stream_socket::{MAX_HISTORY_SIZE, VIDEO, AUDIO, TRACKING, HAPTICS, STATISTICS, INITIAL_BITRATE_MBPS, INITIAL_FRAMERATE_FPS };
...
use crate::lib::{
    exponential, frametransmission_delay, perStaLockStats,
    Coords, CsvType, CumulativeStats, DEFAULT_TMAX_AGG,
...
impl BitrateManager{ // TODO: Add method for CBR
    pub fn new( max_history_size: usize, initial_framerate: f32, initial_bitrate_mbps: f32) -> Self {
        ...
        Self{
            ...
            bitrate_average_mbps: SlidingWindowAverage::new(initial_bitrate_mbps * 1E6, max_history_size), 
...
impl XRServer{
    ...
    pub fn connection_pipeline(&mut self, client_ip: IpAddr, context: &Context<Self>) -> ConResult {
