...
fn main() -> Result<()> {
    ...
    let metric: MetricsLogger = MetricsLogger::new(ip, "AAA")?;
    let mut out_csv = Writer::from_path("/home/boris/Desktop/Rust_MG1/asynchronix/Results/vmaf_summary.csv")?;
    // write header row once:
    out_csv.write_record(&["frame_number","timestamp_ms","vmaf","psnr","ssim"])?;
